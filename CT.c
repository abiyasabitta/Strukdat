    ...
    int main(int argc, char const *argv[])
    {
        ...
        for(i=0; i<t; i++)
        {
            while(!deq_isEmpty(&mydeq) && tempat[i] < tempat[deq_back(&mydeq)])
            {
                deq_popBack(&mydeq);
            }
        ...
        for(;i<n; i++)
        {
            printf("%d\n", tempat[deq_front(&mydeq)]);
     
            while(!deq_isEmpty(&mydeq) && deq_front(&mydeq) <= i-t)
            {
                deq_popFront(&mydeq);
            }
            while(!deq_isEmpty(&mydeq) && tempat[i] < tempat[deq_back(&mydeq)])
