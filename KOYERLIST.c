...
int main(int argc, char const *argv[])
{
    ...
    for(i=0; i<T; i++)
    {
        ...
        for(j=0; j<N; j++)
        {
            ...
            if(j == 0)
            {
                slist_pushFront(&myList, B);
                isi++;
            }
            else
            {
                if(slist_back(&myList) < B)
                {
                    while(slist_back(&myList) < B)
                    {
                        slist_removeAt(&myList, isi-1);
                        isi--;
                        if(slist_front(&myList) == NULL)
                        {
                            slist_pushBack(&myList, B);
                            isi++;
                            break;
                        }
                        else if(slist_back(&myList) > B)
                        {
                            slist_pushBack(&myList, B);
                            isi++;
                            break;
